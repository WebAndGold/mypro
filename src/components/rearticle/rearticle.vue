...
export default{
	...
	created(){
		...
		axios({
			method:'post',
			url:'http://127.0.0.1/allPHP/phpbases/recommend_article.php',
			data:idData,
			responseType:'json'
		}).then((response)=>{
		...
		axios({
			method:'post',
			url:'http://127.0.0.1/allPHP/phpbases/recommend_article1.php',
			data:idData,
			responseType:'json'
		}).then((response)=>{
			console.log(response.data)
		...
		axios({
			method:'post',
			url:'http://127.0.0.1/allPHP/phpbases/getCart.php',
			data:idData1,
			responseType:'json'
		}).then((response)=>{
...
//			console.log(idData1)
			axios({
				method:'post',
				url:'http://127.0.0.1/allPHP/phpbases/addCart.php',
				data:idData1,
				responseType:'json'
			}).then((response)=>{
